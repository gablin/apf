...
def toLatexSub(s):
    ...
    s = s.replace("doppelgaenger", "doppelg\\\"anger")
    s = s.replace("Danae", "Dana\\\"e")
    s = s.replace("Goetterdaemmerung", "G\\\"otterd\\\"ammerung")
    s = s.replace("Bjorn Ulvaeus", "Bj\\\"orn Ulvaeus")
    s = s.replace("if Bjorn is", "if Bj\\\"orn is")
    s = s.replace("Haendel", "H\\\"andel")
    s = s.replace("cliche", "clich\\'e")
    s = s.replace("Goedel", "G\\\"odel")
    s = s.replace("Schroedinger", "Schr\\\"odinger")
    s = s.replace("Quetzovercoatl", "Quetzoverc\\'oatl")
    s = s.replace("flambe", "flamb\\'e")
    s = s.replace("Ole!", "!`Ol\\'e!")
    s = s.replace("Eminence", "\\'Eminence")
    s = s.replace("Cafe", "Caf\\'e")
    s = s.replace("Walkuere", "Walk\\\"ure")
    s = s.replace("Schueschien", "Sch\\\"uschien")
    s = s.replace("Pluen", "Pl\\\"un")
    s = s.replace("Tomas", "Tom\\'as")
    s = s.replace("Nuernberg", "N\\\"urnberg")
    s = s.replace("Blue Oyster", "Blue \\\"Oyster")
    s = s.replace("naive", "na\\\"\i ve")
    s = s.replace("Tir-far-Thionn", "Tir-far-Thi\\'onn")
    s = s.replace("Tir-fa-Tonn", "T\\'\i r-fa-Tonn")
    s = s.replace("unverstaendlich", "unverst\\\"andlich")
    ...
    s = s.replace(" cm", "\\thinspace cm")
    s = s.replace(" kg", "\\thinspace kg")
