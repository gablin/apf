...
%      \pgfornamentvline{UL}{LL}{west}{\vLineOrnNum}
%      \pgfornamentvline{UR}{LR}{east}{\vLineOrnNum}
%      \pgfornamenthline{UL}{UR}{north}{\hLineOrnNum}
%      \pgfornamenthline{LL}{LR}{south}{\hLineOrnNum}
    \end{tikzpicture}
