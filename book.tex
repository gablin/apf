...
\newcommand{\makeCopyrightPage}{%
  ...
  \end{copyrightText}
  \begin{copyrightText}
    \item Cover design\Footnote{*}{The material for the said design have been
      shamelessly taken without prior permission, and copyrights have most
      definitely been infringed. So if you happen to meet the copyright holders
      in question, please don't tell them.} by Gabriel Hjort
      Blindell.
  \end{copyrightText}%
  \begin{copyrightText}
