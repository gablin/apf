...
\newcommand{\makeCopyrightPage}{%
  ...
  \begingroup
    ...
    Typeset by Gabriel Hjort Blindell \typesetUrl{ghb@kth.se} using \LaTeX with
    \emph{Garamond} (11pt) as basefont, \emph{Linux Libertine} as sans-serif
    font, and \emph{Bera Mono} as monotype font.
  \endgroup%
  \pagebreak%
  \twocolumn%
}
