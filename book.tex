...
\newcommand{\makeCopyrightPage}{%
  ...
  \end{copyrightText}
  \begin{copyrightText}
    \item Preprocessing (using Python), typesetting (using \LaTHeX), and cover
      design\Footnote{*}{The material for the said design have been shamelessly
        taken without prior permission, and copyrights have most definitely been
        infringed. So if you happen to meet the copyright holders in question,
        please don't tell them.} by: Gabriel Hjort Blindell
